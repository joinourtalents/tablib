...
setup(
    ...
    packages=[
      ...
      "tablib.packages.omnijson.packages",
      "tablib.packages.omnijson.packages.simplejson",
      ...
      "tablib.packages.xlrd.doc",
      "tablib.packages.xlrd.examples",
      "tablib.packages.xlwt",
      "tablib.packages.xlwt3",
      "tablib.packages.xlwt.doc",
      "tablib.packages.xlwt.examples",
